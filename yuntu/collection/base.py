...
class simpleCollection(metaCollection):
    ...
    def virtualInit(self, dbDump):
        """Init virtual collection in RAM."""
    ...
    def getMetadata(self,
                    ...
                    query=None,
                    iterate=True):
        return colMethods.collectionGetMetadata(self,
                                                orid,
                                                query,
                                                iterate)
    ...
    def getAnnotations(self,
                       ...
                       query=None,
                       iterate=True):
        return colMethods.collectionGetAnnotations(self,
                                                   noteid,
                                                   query,
                                                   iterate)
    ...
    def getSignals(self,
                   ...
                   readSr=None,
                   iterate=True):
        return colMethods.collectionGetSignals(self,
                                               orid,
                                               query,
                                               readSr,
                                               iterate)
    ...
    def getSpecs(self,
                 ...
                 hop_length=512,
                 iterate=True):
        return colMethods.collectionGetSpecs(self,
                                             orid,
                                             query,
                                             readSr,
                                             n_fft,
    ...
    def insertMedia(self,
                    input,
                    parseSeq=None):
        return colMethods.collectionInsert(self,
                                           input,
                                           parseSeq)

    def annotate(self,
                 dataArr):
        return colMethods.collectionAnnotate(self,
                                             dataArr)

    def dropMedia(self,
                  where=None,
                  query=None):
        return colMethods.collectionDropMedia(self,
                                              where,
                                              query)

    def pullDatastore(self,
                      dsDict,
                      parseSeq=None):
        return colMethods.collectionPullDatastore(self,
                                                  dsDict,
                                                  parseSeq)
    ...
    def transformMetadata(self,
                          ...
                          query=None,
                          operation="append"):
        return colMethods.collectionTransform(self,
                                              parseSeq,
                                              id,
                                              where,
                                              query,
    ...
    def getSize(self,
                where=None,
                query=None):
        return colMethods.collectionGetSize(self,
                                            where,
                                            query)
    ...
    def dump(self,
             dirPath,
             overwrite=False):
        return colMethods.collectionDump(self,
                                         dirPath,
                                         overwrite)
    ...
    def materialize(self,
                    dirPath=None,
                    overwrite=False):
        return colMethods.collectionMaterialize(self,
                                                dirPath,
                                                overwrite)
    ...
    def doggyBag(self,
                 dirPath="",
                 outName=None):
        return colMethods.collectionDoggyBag(self,
                                             dirPath,
                                             outName)
    ...
    def toDisk(self,
               dirPath,
               overwrite=False):
        return colMethods.collectionToDisk(self,
                                           dirPath,
                                           overwrite)

    def server(self,
               port=9797):
        return colMethods.collectionServer(self,
                                           port)
...
class timedCollection(simpleCollection):
    ...
    def __init__(self,
        ...
        super(timedCollection, self).__init__(**{"name": name,
                                                 "dirPath": dirPath,
                                                 "metadata": metadata,
                                                 "virtual": virtual,
                                                 "dbDump": dbDump,
    ...
    def insertMedia(self,
                    input,
                    parseSeq=None):
        return colMethods.collectionTimedInsert(self,
                                                input,
                                                parseSeq)

    def build(self,
              dbDump=None):
        if colMethods.collectionBuild(self,
                                      dbDump):
